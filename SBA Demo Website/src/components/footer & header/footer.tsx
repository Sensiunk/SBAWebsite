  ...
  return (
    ...
    >
      <div className="container p-4 pb-0">
        <section className="">
          <div className="row">
            ...
            <div className="col-lg-2 col-md-6 mb-4 mb-md-0 me-auto">
              <h5 className="text-uppercase">Links 3</h5>
            ...
            <div className="col-lg-2 col-md-6 mb-4 mb-md-0 me-auto">
              <h5 className="text-uppercase">Links 4</h5>
      ...
      <div className="text-center p-3" style={{ backgroundColor: "gray" }}>
        ©{new Date().getFullYear()} Snoqualmie Bharath Association. All rights
        reserved.
      </div>
    </footer>
  );
